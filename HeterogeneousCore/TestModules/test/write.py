...
process.assproducer = cms.EDProducer("AssociationCollectionProducer")

# write all products to a 'test.root' file
process.output = cms.OutputModule('PoolOutputModule',
    fileName = cms.untracked.string('associationMap.root'),
    outputCommands = cms.untracked.vstring('keep *')
)

# Add to process path
process.p = cms.Path(process.assproducer)
