...
process.soaproducer = cms.EDProducer("SoAProducerTracking@alpaka", soaParameter = cms.int32(42))
# MultiCollectionProducer creates a MultiCollection that takes the PortableDeviceCollections

process.multiCollectionproducer = cms.EDProducer("MultiCollectionProducerTracking@alpaka",
...
# process.deviceconsumer = cms.EDProducer("DeviceConsumerTracking@alpaka", 
