#ifndef TrackingRecHitExample_interface_TrackingRecHitsSoA_h
#define TrackingRecHitExample_interface_TrackingRecHitsSoA_h
...
namespace reco {
  ...
  GENERATE_SOA_BLOCKS(TrackingBlocksLayout, SOA_BLOCK(TrackingHits, TrackingHitsLayout), SOA_BLOCK(HitModules, HitModulesLayout))
  ...
  using TrackingBlocks = TrackingBlocksLayout<>;
  using TrackingBlocksView = TrackingBlocks::View;
  using TrackingBlocksConstView = TrackingBlocks::ConstView;  
...
#endif // TrackingRecHitExample_interface_TrackingRecHitsSoA_h
