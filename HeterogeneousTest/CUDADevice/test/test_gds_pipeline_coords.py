...
if len(sys.argv) < 2:
    raise RuntimeError("Usage: cmsRun test_gds_pipeline.py gds_flag [input_file] [max_events]")

gds_flag = bool(int(sys.argv[1]))
input_file = sys.argv[2] if len(sys.argv) > 2 else \
    "/scratch/CMSSW_20_1_X_2026-08-08-1100/src/store/run402360/run402360_ls0214_index000000.raw"
